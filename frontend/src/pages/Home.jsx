    ...
    <div className="space-y-12">
      ...
      <section className="text-center py-12">
        ...
        <p className="text-xl text-[var(--color-text-secondary)] max-w-2xl mx-auto mb-8">
          Gerencie suas festas e serviços de forma simples e eficiente. Crie eventos incríveis e organize todos os
          detalhes em um só lugar!
        </p>
      ...
      <section className="grid md:grid-cols-2 gap-6">
        ...
        >
          ...
          <p className="text-[var(--color-text-secondary)] mb-4">
            Organize e acompanhe todas as suas festas. Adicione serviços, defina orçamentos e mantenha tudo sob
            controle.
          </p>
        ...
        >
          ...
          <p className="text-[var(--color-text-secondary)] mb-4">
            Crie e gerencie o catálogo de serviços disponíveis para suas festas. Defina preços, descrições e muito mais.
          </p>
